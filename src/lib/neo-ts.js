        ...
        var ECDsa = (function () {
            ...
            ECDsa.prototype.sign = function (message) {
                ...
                do {
                    ...
                    do {
                        do {
                            k = Neo.BigInteger.random(this.key.publicKey.curve.N.bitLength(), crypto);
...
(function (Neo) {
    ...
    (function (Cryptography) {
        ...
        String.prototype.toAesKey = function () {
            ...
            return crypto.subtle.digest({ name: "SHA-256" }, codes).then(function (result) {
        ...
        function hook_ripemd160() {
            var digest_old = crypto.subtle.digest;
        ...
        hook_ripemd160();
        function hook_ecdsa() {
            var exportKey_old = crypto.subtle.exportKey;
            ...
            var generateKey_old = crypto.subtle.generateKey;
            ...
            var importKey_old = crypto.subtle.importKey;
            ...
            var sign_old = crypto.subtle.sign;
            ...
            var verify_old = crypto.subtle.verify;
