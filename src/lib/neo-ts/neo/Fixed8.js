...
var Fixed8 = /** @class */ (function () {
    ...
    Object.defineProperty(Fixed8, "MaxValue", {
        get: function () { return _max || (_max = new Fixed8(new index_1.Uint64(0xffffffff, 0x7fffffff))); },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(Fixed8, "MinusOne", {
        get: function () { return _minus || (_minus = new Fixed8(new index_1.Uint64(0xffffffff, 0xffffffff))); },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(Fixed8, "MinValue", {
        get: function () { return _min || (_min = new Fixed8(index_1.Uint64.MinValue)); },
        enumerable: true,
        configurable: true
    });
    ...
    Object.defineProperty(Fixed8, "Satoshi", {
        get: function () { return _satoshi || (_satoshi = new Fixed8(new index_1.Uint64(1))); },
        enumerable: true,
        configurable: true
    });
    ...
    Fixed8.fromNumber = function (value) {
        ...
        if (value >= 0x8000000000000000)
            throw new RangeError();
        var array = new Uint32Array((new index_1.BigInteger(value)).toUint8Array(true, 8).buffer);
        return new Fixed8(new index_1.Uint64(array[0], array[1]));
    };
    ...
    Fixed8.parse = function (str) {
        ...
        if (digits > 8)
            ...
            for (var i = digits; i < 8; i++)
                str += '0';
        return new Fixed8(index_1.Uint64.parse(str));
    };
