...
class BinaryReader {
    ...
    readFixed8() {
        return new Fixed8_1.Fixed8(this.readUint64());
    }
    readInt16() {
    ...
    readUint160() {
        return new Uint160_1.Uint160(this.readBytes(20));
    }
    readUint256() {
        return new Uint256_1.Uint256(this.readBytes(32));
    }
    readUint32() {
        this.fillBuffer(this._buffer, 4);
    ...
    readUint64() {
        ...
        return new Uint64_1.Uint64(this.array_uint32[0], this.array_uint32[1]);
    }
