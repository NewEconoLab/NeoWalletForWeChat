...
export class ECCurve {
    ...
    public static get secp256k1(): ECCurve {
        return _secp256k1 || (_secp256k1 = new ECCurve(
            ...
            Helper.hexToBytes(("04" + "79BE667EF9DCBBAC55A06295CE870B07029BFCDB2DCE28D959F2815B16F81798" + "483ADA7726A3C4655DA4FBFC0E1108A8FD17B448A68554199C47D08FFB10D4B8"))
        ));
    }
    ...
    public static get secp256r1(): ECCurve {
        return _secp256r1 || (_secp256r1 = new ECCurve(
            ...
            Helper.UintHelper.hexToBytes("04" + "6B17D1F2E12C4247F8BCE6E563A440F277037D812DEB33A0F4A13945D898C296" + "4FE342E2FE1A7F9B8EE7EB4A7C0F9E162BCE33576B315ECECBB6406837BF51F5")
        ));
    }
