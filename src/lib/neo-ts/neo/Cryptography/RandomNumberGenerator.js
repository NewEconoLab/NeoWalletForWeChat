...
class RandomNumberGenerator {
    ...
    static getRandomValues(array) {
        ...
        if (RandomNumberGenerator._key == null) {
            ...
            RandomNumberGenerator._key = new Uint8Array(Sha256_1.Sha256.computeHash(data));
        }
        let aes = new Aes_1.Aes(RandomNumberGenerator._key, RandomNumberGenerator.getWeakRandomValues(16));
        ...
        for (let i = 0; i < dst.length; i += 16) {
            ...
            index_1.Arrayhelper.copy(src, 0, dst, i, Math.min(dst.length - i, 16));
        }
        return array;
    }
